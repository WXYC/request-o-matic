...
- Terse messages like "song title. artist name.", "song - artist", "song title, artist name", or "song by artist" should extract both song and artist. The word "by" in "X by Y" is a preposition indicating authorship -- Y is the artist, not an album. This applies even when the song title contains common words like "love", "hate", "like", etc., or when the song title is itself a short common word that resembles a temporal adverb (e.g., "today", "tonight", "yesterday"). For example, "I love acid, luke vibert" is a request for the song "I Love Acid" by Luke Vibert, not feedback; likewise "Today, Jefferson Airplane" is a request for the song "Today" by Jefferson Airplane (song="Today", artist="Jefferson Airplane"), not a temporal aside. A genuine greeting prefix is still dropped: "Good morning, Jefferson Airplane" means artist="Jefferson Airplane" with no song.
